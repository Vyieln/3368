...
def option_delcontact():
    ...
    print("id      Name        Creation Date        Phone")
    for cont in contacts:
        ins = "%s - %s - (%s) - (%s) " % (cont[0],cont[1],cont[2],cont[3])
        print(ins)
...
# Day 7 
# fixed the output, adding format to the table and adding the phonenum collum since i forgot to add it 
# removed some errors that i had in the code aswell